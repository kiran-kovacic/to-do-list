...
define('DB_NAME', 'to_do_list'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'To_do_list'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
